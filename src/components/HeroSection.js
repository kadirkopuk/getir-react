      ...
      <Slider className="h-full hidden sm:block" {...settings}>
        <div>
          <div
            ...
            style={{
              backgroundImage: "url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-4.jpg)",
            }}
          ></div>
        </div>
        <div>
          <div
            className="h-[500px] bg-center bg-no-repeat bg-cover"
            style={{
              backgroundImage: "url(https://cdn.getir.com/getirweb-images/common/hero-posters/getir-mainpage-2.jpg)",
            }}
          ></div>
        </div>
      </Slider>
        ...
        <div className="w-full sm:container flex mx-auto justify-between items-center">
          ...
          <div className="w-full sm:w-[400px] bg-gray-50 sm:rounded-lg px-5 py-3 pb-5 sm:py-6">
            ...
            <div className="flex flex-col gap-y-3">
              ...
              <button className="h-12 rounded-lg transition-colors bg-brand-yellow text-purple-700 text-sm font-semibold hover:bg-purple-700 hover:text-yellow-300">
